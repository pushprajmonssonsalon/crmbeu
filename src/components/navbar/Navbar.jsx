    ...
    <nav className='flex flex-row justify-between items-center nav px-6 flex-wrap bg-[#191919] fixed  top-0 z-10 w-full '>
            ...
            <div>
                <ul className='flex flex-row justify-between items-center'>
                    <li className ='mx-6 font-medium inter text-sm md:text-lg text-slate-100 cursor-pointer hover:border-b-2 border-gray-300'>{parlorDetails?.phoneNumber}</li>
                </ul>
            </div>

            <div>
            <ul className='flex flex-row justify-between items-center'>
                    <li className ='mx-6 font-medium inter text-sm md:text-lg text-slate-100 cursor-pointer hover:border-b-2 border-gray-300'>{parlorDetails?.name}</li>
                    <li className ='mx-6 font-medium inter text-sm md:text-lg text-slate-100 cursor-pointer hover:border-b-2 border-gray-300'>{parlorDetails?.address}</li>
                ...
                <h3 className='font-semibold text-sm md:text-lg poppins' onClick={adminPress}>Admin</h3>
                </button></li>
                </ul>
            </div>
            {admin && (
