...
import { MdOutlineAddShoppingCart, MdOutlineClose } from "react-icons/md";
...
const handleSubmitOrder=()=>{
  ...
  return (
    <div className='fixed z-30 inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center'>
        <div className='absolute z-40 mx-3 w-1/2 my-10'>

            <div className='bg-white p-4 rounded-xl '>
                <div className='flex justify-between font-bold items-center'>
                <h1 className={`text-blue-500 text-lg font-bold mb-4 `}>Place your order</h1>
            ...
            <button className={`bg-blue-400 text-white font-bold p-3 hover:text-gray-500 rounded-xl`} onClick={handleSubmitOrder} >Submit</button>
